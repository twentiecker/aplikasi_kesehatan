...
text_res1 = 'Rendah, temui dokter anda sekarang'
text_res2 = 'Memuaskan, temui dokter anda sekarang'
text_res3 = 'Rata-rata, mungkin ada baiknya menemui dokter anda untuk diperiksa'
text_res4 = 'Diatas purata'
text_res5 = 'Tinggi'
